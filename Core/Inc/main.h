...
#define TX_SDN_Pin GPIO_PIN_0
#define TX_SDN_GPIO_Port GPIOC
#define WDO_Pin GPIO_PIN_2
#define WDO_GPIO_Port GPIOC
#define WDEN_Pin GPIO_PIN_3
#define WDEN_GPIO_Port GPIOC
#define TX_nSEL_Pin GPIO_PIN_0
#define TX_nSEL_GPIO_Port GPIOA
